(() => {
  ...
  function fixCoaches(s){
    ...
    // Exact staff row centers measured from the supplied 1240 x 1754 sheet.
    place(byText(A.coach,42,50),26.2,46.41,{size:'clamp(8px,.85vw,12px)'});
    place(byText(A.assistant,42,51),26.2,47.78,{size:'clamp(8px,.85vw,12px)'});
    place(byText(B.coach,80,87),26.2,83.10,{size:'clamp(8px,.85vw,12px)'});
    place(byText(B.assistant,80,88),26.2,84.52,{size:'clamp(8px,.85vw,12px)'});
  }
